        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo base_url('zone/edit'); ?>">Edit Zone</a>
                    </li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Edit Zone
                            </div>
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            $ZoneName_field = array(
                                                ...
                                                'id' => '',
                                                'value' => set_value('ZoneName',!empty($content->ZoneName) ? $content->ZoneName:'')
                                            );
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            $remarks_field = array(
                                                ...
                                                'id' => '',
                                                'value' => set_value('ZoneCode',!empty($content->ZoneCode) ? $content->ZoneCode:'')
                                                );
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <select name="ParentZoneID" class="form-control">
                                                    ...
                                                    <?php 
                                     $this->zone_model->getTreeCategory(0, 0, $content->ParentZoneID); 
