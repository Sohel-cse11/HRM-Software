                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box grey-cascade">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>Day Table
                            </div>    
                        </div>
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                         <a href="<?php echo base_url('daytype/add') ?>">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                   ...
                                   <?php echo ($con->IsHolyDay == 1) ? 'Yes' : 'No'; ?>
                                </td>
                                <td>
                                  <?php echo $con->Remarks; ?>
                                </td>
                                <td >
                                   <a href="<?php echo base_url('daytype/edit/' . $con->DayTypeID) ?>" class="btn default btn-xs purple" onClick="return confirm('Do you want to edit this item?');" ><i class="fa fa-edit"></i>Edit</a>  
                                </td>
                                <td>
