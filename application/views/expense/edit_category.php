		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('expense/category'); ?>">Category</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<?php echo base_url('expense/edit_category'); ?>">Edit Category</a>
					</li>
									...
									<div class="form-group">
										...
										<?php
                                            $category_name = array(
                                                ...
                                                'id' => '',
                                               'value' => set_value('category_name',(!empty($content->category_name)) ? $content->category_name : '')
                                            );
                                            echo form_input($category_name);
                                            echo form_error('category_name', '<p class="text-danger">', '</p>');
                                            ?>
										</div>
									</div>
