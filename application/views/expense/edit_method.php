		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('expense/method'); ?>">Payment Method</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<?php echo base_url('expense/edit_method'); ?>">Edit Payment Method</a>
					</li>
									...
									<div class="form-group">
										...
										<?php
                                            $method_name = array(
                                                ...
                                                'id' => '',
                                               'value' => set_value('method_name',(!empty($content->method_name)) ? $content->method_name : '')
                                            );
                                            echo form_input($method_name);
                                            echo form_error('method_name', '<p class="text-danger">', '</p>');
                                            ?>
										</div>
									</div>
