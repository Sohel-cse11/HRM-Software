                    ...
                    <?php } ?>
						<div class="row">
									...
									<div class="btn-group pull-right">
										<div class="btn-group">
										<a href="<?php echo base_url("expense/add_employee_expense");?>">
					...
					<div class="portlet box blue-hoki">
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<td class="text-center">
									<a href="<?php echo base_url('expense/edit_employee_expense/' . $con->ee_id) ?>" class="btn default btn-xs purple" onClick="return confirm('Do you want to edit this item?');"><i class="fa fa-edit"></i>Edit</a>|| <a href="<?php echo base_url('expense/delete_employee_expense/' . $con->ee_id) ?>" class="btn default btn-xs red" onClick="return confirm('Do you want to delete this item?');"><i class="fa fa-delete"></i>Delete</a>
								</td>
							</tr>
