                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            $Project_Name_field = array(
                                                ...
                                                'id' => '',
                                                'value' => set_value('project_name',!empty($content->project_name)? $content->project_name:'')
                                            );
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="client" class="form-control">
                                                     <?php
                                                    $client = set_value('client',$content->client);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="status" class="form-control">
                                                     <?php
                                                    $status = set_value('status',$content->status);
