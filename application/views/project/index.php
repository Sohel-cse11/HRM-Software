					...
					<div class="portlet box blue-hoki">
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<td class="text-center">
									<a href="<?php echo base_url('project/edit/' . $con->p_id) ?>" class="btn default btn-xs purple" onClick="return confirm('Do you want to edit this item?');"><i class="fa fa-edit"></i>Edit</a>|| <a href="<?php echo base_url('project/delete/' . $con->p_id) ?>" class="btn default btn-xs red" onClick="return confirm('Do you want to delete this item?');"><i class="fa fa-delete"></i>Delete</a>
								</td>
							</tr>
