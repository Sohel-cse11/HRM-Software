				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Employee Salary Component
							</div>
						</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="employee" class="form-control">
                                                     <?php
                                                    $employee = set_value('employee',$contnet->employee);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="component" class="form-control">
                                                     <?php
                                                    $componentType = set_value('component',$contnet->component);
                                    ...
                                    <div class="form-group">
										...
										<?php
                                            $amount = array(
                                                ...
                                                'id' => '',
                                               'value' => set_value('amount',!empty($content->amount)? $content->amount:'')
                                            );
