		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('salary/add_salary_component'); ?>">Add Salary Component</a>
					</li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Add Salary Component
							</div>
						</div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="componentType" class="form-control">
                                                     <?php
                                                    $componentType = set_value('componentType');
