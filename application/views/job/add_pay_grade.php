		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('job/add_pay_grade'); ?>">Add Pay Grade</a>
					</li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Add Pay Grade
							</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
									...
									<div class="form-group">
										<label class="control-label col-md-3"> Pay Grade Name </label>
										<div class="col-md-4">
										<?php
                                            $name = array(
                                                'name' => 'name',
									...
									<div class="form-group">
										...
										<?php
                                            $min_salary = array(
                                                'name' => 'min_salary',
                                                'class' => 'form-control',
                                                'placeholder' => 'Enter min salary  here',
                                                'id' => '',
									...
									<div class="form-group">
										...
										<?php
                                            $max_salary = array(
                                                'name' => 'max_salary',
                                                'class' => 'form-control',
                                                'placeholder' => 'Enter max salary  here',
                                                'id' => '',
                                                'value' => set_value('max_salary')
                                            );
