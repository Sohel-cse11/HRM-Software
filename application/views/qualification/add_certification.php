		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('qualification/certification'); ?>">Education</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<?php echo base_url('qualification/add_certification'); ?>">Add Certification</a>
					</li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Add Certification
							</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
									...
									<div class="form-group">
										<label class="control-label col-md-3"> Certification Name </label>
										<div class="col-md-4">
										<?php
                                            $name = array(
                                                'name' => 'name',
