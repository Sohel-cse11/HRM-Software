		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('job_require/add'); ?>">Add Job Position</a>
					</li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Add Job Position
							</div>
						</div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="employee_type" class="form-control">
                                                     <?php
                                                    $employee_type = set_value('employee_type');
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="job_function" class="form-control">
                                                     <?php
                                                    $job_function = set_value('job_function');
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group input-large date-picker input-daterange" data-date="" data-date-format="yyyy-mm-dd">
                                                ...
                                                $date_end = array(
                                                    ...
                                                    'id' => '',
                                                    'value' => set_value('deadline', date('Y-m-d'))
                                                );
