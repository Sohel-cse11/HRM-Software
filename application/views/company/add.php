        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo base_url('company/add'); ?>">Add Company</a>
                    </li>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="ZoneID" class="form-control">
                                                ...
                                                <?php
                                                $zone_val = set_value('ZoneID');
                                                
                                                $this->zone_model->getTreeCategory(0, 0, $zone_val); 
                                                ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="ParentCompanyID" class="form-control">
                                               <option value="">Select A Parent CompanyHere.</option>
                                                <?php
                                                $ParentCompanyID = set_value('ParentCompanyID');
                                                
                                                $this->company_model->getTreeCategory(0, 0, $ParentCompanyID);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select name="IsOwner" class="form-control">
                                                <!--                                            <option value="">Select Software Owner</option>-->
                                                <?php
