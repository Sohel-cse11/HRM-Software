                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Edit Travel
                            </div>
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            $purpose = array(
                                                ...
                                                'cols' => 3,
                                                'rows' => 5,
                                               'value' => set_value('purpose',!empty($content->purpose)? $content->purpose:'')
                                                );
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            $travel_from = array(
                                                ...
                                                'id' => '',
                                                'value' => set_value('travel_from',!empty($content->travel_from)? $content->travel_from:'')
                                            );
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            $travel_to = array(
                                                ...
                                                'id' => '',
                                                'value' => set_value('travel_to',!empty($content->travel_to)? $content->travel_to:'')
                                            );
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            $funding = array(
                                                ...
                                                'id' => '',
                                                'value' => set_value('funding',!empty($content->funding)? $content->funding:'')
                                            );
