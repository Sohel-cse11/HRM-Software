				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Employee's Leave
							</div>
						</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="emp_name" class="form-control">
                                                     <?php
                                                    $job_title = set_value('emp_name',$content->emp_name);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="leave_type" class="form-control">
                                                     <?php
                                                    $job_title = set_value('leave_type',$content->leave_type);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                            $code = array(
                                                ...
                                                'value' => set_value('day',(!empty($content->day)) ? $content->day : '')
                                            );
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group input-large date-picker input-daterange" data-date="" data-date-format="yyyy-mm-dd">
                                                ...
                                                $date_end = array(
                                                    ...
                                                    'id' => '',
                                                'value' => set_value('start_date',(!empty($content->start_date)) ? $content->start_date : '')
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group input-large date-picker input-daterange" data-date="" data-date-format="yyyy-mm-dd">
                                                ...
                                                $date_end = array(
                                                    ...
                                                    'id' => '',
                                                    'value' => set_value('end_date',(!empty($content->end_date)) ? $content->end_date : '')
                                                );
                                                echo form_input($date_end);
                                                ?>
									...
									<div class="form-group">
										...
										<?php
                                            $code = array(
                                                ...
                                                'value' => set_value('reason',(!empty($content->reason)) ? $content->reason : '')
                                            );
                                            echo form_input($code);
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="status" class="form-control">
                                                     <?php
                                                    $job_title = set_value('status',$content->status);
