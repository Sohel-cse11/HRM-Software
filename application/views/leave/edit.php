		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('leave'); ?>"> Leave</a>
						<i class="fa fa-angle-right"></i>
					</li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Leave
							</div>
						</div>
									...
									<div class="form-group">
										...
										<?php
                                            $code = array(
                                                'name' => 'leave_name',
                                                'class' => 'form-control',
                                                'placeholder' => 'Enter leave_name  here',
                                               
                                                'value' => set_value('leave_name',(!empty($content->leave_name)) ? $content->leave_name : '')
                                            );
                                            echo form_input($code);
                                            echo form_error('leave_name', '<p class="text-danger">', '</p>');
                                            ?>
										</div>
									</div>
									
									<div class="form-group">
										<label class="control-label col-md-3"> Leaves Per Year </label>
										<div class="col-md-4">
										<?php
                                            $code = array(
                                                'name' => 'leaves_per_year',
                                                'class' => 'form-control',
                                                'placeholder' => 'Enter leaves_per_year  here',
                                                'id' => '',
                                                 'cols' => 3,
                                                'rows' => 5,
                                                'value' => set_value('leaves_per_year',(!empty($content->leaves_per_year)) ? $content->leaves_per_year : '')
                                            );
                                            echo form_input($code);
                                            echo form_error('leaves_per_year', '<p class="text-danger">', '</p>');
                                            ?>
										</div>
									</div>
