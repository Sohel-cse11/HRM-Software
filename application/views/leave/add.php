		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('leave/add'); ?>">Add Leave </a>
					</li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Add Leave
							</div>
						</div>
									...
									<div class="form-group">
										...
										<?php
                                            $name = array(
                                                ...
                                                'class' => 'form-control',
                                                'placeholder' => 'Enter Leaves Per Year here',
                                                'id' => '',
                                                'value' => set_value('leaves_per_year')
                                            );
