				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Notice
							</div>
						</div>
									...
									<div class="form-group">
										...
										<?php
                                            $name = array(
                                                ...
                                                'id' => '',
                                                'value' => set_value('message_title',!empty($content->message_title)? $content->message_title:'')
                                            );
										...
										<?php
                                            $description = array(
                                                ...
                                                'id' => '',
                                                 'cols' => 3,
                                                'rows' => 5,
                                                'value' => set_value('message',!empty($content->message)? $content->message:'')
                                            );
