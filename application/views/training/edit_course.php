				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Course
							</div>
						</div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="coordinator" class="form-control">
                                                     <?php
                                                    $coordinator = set_value('coordinator', $content->coordinator);
									...
									<div class="form-group">
										...
										<?php
                                            $trainer = array(
                                                ...
                                                'id' => '',
                                                 'value' => set_value('trainer',!empty($content->trainer)? $content->trainer:'')
                                            );
									...
									<div class="form-group">
										...
										<?php
                                            $trainer = array(
                                                ...
                                                'cols' => 3,
                                                'rows' =>5,
                                                 'value' => set_value('trainer_details',!empty($content->trainer_details)? $content->trainer_details:'')
                                            );
