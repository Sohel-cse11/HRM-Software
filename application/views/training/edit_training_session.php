				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Session
							</div>
						</div>
									...
									<div class="form-group">
										...
										<?php
                                            $name = array(
                                                ...
                                                'id' => '',
                                                'value' => set_value('session_name',!empty($content->session_name)? $content->session_name:'')
                                            );
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="course_id" class="form-control">
                                                     <?php
                                                    $course_id = set_value('course_id',$content->course_id);
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="delivery_id" class="form-control">
                                                     <?php
                                                    $course_id = set_value('delivery_id',$content->delivery_id);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="attendance_id" class="form-control">
                                                     <?php
                                                    $course_id = set_value('attendance_id',$content->attendance_id);
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="employee" class="form-control">
                                                     <?php
                                                    $employee_id = set_value('employee',$content->employee);
