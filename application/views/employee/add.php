                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            $EmergencyContactPerson_field = array(
                                                ...
                                                'id' => '',
                                                'value' => set_value('emergencycontactperson')
                                                );
                                       ...
                                       <label class="control-label col-md-3">Emergency Contact No</label>
                                        <div class="col-md-4">
                                            ...
                                            $EmergencyContactNo_field = array(
                                                ...
                                                'id' => '',
                                                'value' => set_value('emergencycontactno')
                                            );
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            $permanent_address = array(
                                                ...
                                                'rows' => 5,
                                                'id' => '',
                                                'value' => set_value('permanent_address')
                                                );
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <?php echo form_error('supervisor', '<p class="text-danger">', '</p>');?>
                                                   ...
                                                   <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <?php
                                                                echo form_upload(array('name' => 'profileimage', 'class' => 'form-control', 'placeholder' => '', 'id' => '', 'value' => set_value('')));
