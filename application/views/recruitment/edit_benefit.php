                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Edit Benefits
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            $name = array(
                                                'name' => 'benefit_name',
                                                'class' => 'form-control',
                                                'placeholder' => 'Enter benefit_name here',
                                                'id' => '',
                                                'value' => set_value('benefit_name',!empty($content->benefit_name)? $content->benefit_name:'')
                                            );
                                            echo form_input($name);
                                            echo form_error('benefit_name', '<p class="text-danger">', '</p>');
                                            ?>
                                        </div>
                                    </div>
