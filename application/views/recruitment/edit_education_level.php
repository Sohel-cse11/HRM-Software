                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Edit Education Level
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            $name = array(
                                                ...
                                                'class' => 'form-control',
                                                'placeholder' => 'Enter education_level_name here',
                                                'id' => '',
                                                'value' => set_value('education_level_name',!empty($content->education_level_name)? $content->education_level_name:'')
                                            );
