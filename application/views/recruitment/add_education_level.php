		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('recruitment/add_education_level'); ?>">Add  Education Level </a>
					</li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Add  Education Level 
							</div>
						</div>
									...
									<div class="form-group">
										...
										<?php
                                            $name = array(
                                                ...
                                                'class' => 'form-control',
                                                'placeholder' => 'Enter Education Level here',
                                                'id' => '',
                                                'value' => set_value('education_level_name')
                                            );
                                            echo form_input($name);
                                            echo form_error('education_level_name', '<p class="text-danger">', '</p>');
                                            ?>
										</div>
									</div>
