                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Edit Experience Level
                            </div>
                            ...
                            <!-- BEGIN FORM-->
                                   <?php
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3"> Experience Level </label>
                                        <div class="col-md-4">
                                            <?php
                                            $name = array(
                                                'name' => 'experience_name',
                                                'class' => 'form-control',
                                                'placeholder' => 'Enter experience_name here',
                                                'id' => '',
                                                'value' => set_value('experience_name',!empty($content->experience_name)? $content->experience_name:'')
                                            );
