		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('recruitment/add_employee_type'); ?>">Add Employee Types</a>
					</li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Add Employee Types
							</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
									...
									<div class="form-group">
										<label class="control-label col-md-3"> Employee Types Name </label>
										<div class="col-md-4">
										<?php
                                            $name = array(
                                                'name' => 'employee_type_name',
                                                'class' => 'form-control',
                                                'placeholder' => 'Enter Employee Type Name here',
                                                'id' => '',
                                                'value' => set_value('employee_type_name')
                                            );
