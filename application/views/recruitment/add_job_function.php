		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('recruitment/add_job_function'); ?>">Add Job Function</a>
					</li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Add Job Function
							</div>
						</div>
									...
									<div class="form-group">
										...
										<?php
                                            $name = array(
                                                ...
                                                'class' => 'form-control',
                                                'placeholder' => 'Enter Job Function Name here',
                                                'id' => '',
                                                'value' => set_value('job_function_name')
                                            );
