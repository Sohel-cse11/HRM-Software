		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('recruitment/employee_type'); ?>">Experience Level</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<?php echo base_url('recruitment/add_experience_level'); ?>">Add Experience Level</a>
					</li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Add Experience Level
							</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
									...
									<div class="form-group">
										<label class="control-label col-md-3"> Experience Level Name </label>
										<div class="col-md-4">
										<?php
                                            $name = array(
                                                'name' => 'experience_name',
                                                'class' => 'form-control',
                                                'placeholder' => 'Enter Experience Level Name here',
                                                'id' => '',
                                                'value' => set_value('experience_name')
                                            );
                                            echo form_input($name);
                                            echo form_error('experience_name', '<p class="text-danger">', '</p>');
                                            ?>
										</div>
									</div>
