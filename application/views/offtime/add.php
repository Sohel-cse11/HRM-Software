        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo base_url('offtime/add'); ?>">Add</a>
                    </li>
                </ul>
            </div>
            <!-- END PAGE HEADER-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <select name="DayTypeId" class="form-control" id="DayTypeId">
                                                <?php
                                                $daytype_list_val = set_value('DayTypeId', 1); // 1 = Regular Day
                                            ...
                                            <?php echo form_error('DayTypeId', '<p class="text-danger">', '</p>');?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            $InTime_field = array(
                                                ...
                                                'id' => '',
                                                'value' => set_value('InTime', '08:30:00')
                                            );
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            $ConsiderableInTime_field = array(
                                                ...
                                                'id' => '',
                                                'value' => set_value('ConsiderableInTime', '08:40:00')
                                                );
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            $OutTime_field = array(
                                                ...
                                                'id' => '',
                                                'value' => set_value('OutTime', '05:30:00')
                                                );
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            $ConsiderableOutTime_field = array(
                                                ...
                                                'id' => '',
                                                'value' => set_value('ConsiderableOutTime', '05:30:00')
                                                );
